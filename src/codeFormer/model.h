...
protected:
  virtual void Run(const std::vector<Tensor_t> &input_tensor,
                   std::vector<Tensor_t> &output_tensor) = 0;
  virtual void PreProcess(const void *input_data,
                          std::vector<Tensor_t> &input_tensor) = 0;
  virtual void PostProcess(const std::vector<Tensor_t> &input_tensor,
